...
<BODY>
	...
	<s:form id="form1" name="form1" method="post" action="salePlan_add.action"  namespace="/" theme="simple" onsubmit="return add()">	
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：开发记录管理 &gt; 添加开发记录</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td bgcolor="#F0F8FF" style="border: 1px solid #CDC5BF">
									<s:label name="saleChance.sale_name"/>
								</td>
							</tr>
