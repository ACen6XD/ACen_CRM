...
<BODY>	
		<s:form id="form1" name="form1" action="customer_add.action" namespace="/" method="post" theme="simple" onsubmit="return add()">
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<s:hidden name="sale_id" value="%{saleChance.sale_id}"/>
							<TR>
						...
						<TR>
								...
								<td bgcolor="#F0F8FF" style="border: 1px solid #CDC5BF">
									<s:textfield name="cust_name" readonly="true"/>
								</td>
								<td bgcolor="#87CEFF" style="border: 1px solid #CDC5BF">客户来源 ：</td>
								<td bgcolor="#F0F8FF" style="border: 1px solid #CDC5BF">
									<s:textfield name="cust_source.dict_item_name" readonly="true"/>
							...
							<tr>
								...
								<td bgcolor="#F0F8FF" style="border: 1px solid #CDC5BF">
									<s:label name="cust_respman.user_realname" style="width:180px" maxLength="50"/>
